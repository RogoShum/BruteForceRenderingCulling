...
public class ConfigScreen extends Screen {
    ...
    public void renderBackground(PoseStack p_96557_) {
        ...
        int height = minecraft.getWindow().getGuiScaledHeight()/2+minecraft.getWindow().getGuiScaledHeight()/10;
    ...
    protected void init() {
        ...
        NeatButton depthUpdate = new NeatButton(width/2-50, height/2+12, 100, 14
                , (button) -> {
            Config.UPDATE_DEPTH.set(!Config.UPDATE_DEPTH.get());
            Config.UPDATE_DEPTH.save();
        }, () -> (Config.UPDATE_DEPTH.get() ? new TranslatableComponent("brute_force_rendering_culling.disable").append(" ").append(new TranslatableComponent("brute_force_rendering_culling.depth_update"))
                : new TranslatableComponent("brute_force_rendering_culling.enable").append(" ").append(new TranslatableComponent("brute_force_rendering_culling.depth_update"))));
        NeatButton close = new NeatButton(width/2-50, height/2-heightScale*2+12, 100, 14 , (button) -> {
            CullingHandler.CULLING = !CullingHandler.CULLING;
            button.setMessage((CullingHandler.CULLING ? new TranslatableComponent("brute_force_rendering_culling.disable").append(" ").append(new TranslatableComponent("brute_force_rendering_culling.culling"))
                    : new TranslatableComponent("brute_force_rendering_culling.enable").append(" ").append(new TranslatableComponent("brute_force_rendering_culling.culling"))));
        }, () -> (CullingHandler.CULLING ? new TranslatableComponent("brute_force_rendering_culling.disable").append(" ").append(new TranslatableComponent("brute_force_rendering_culling.culling"))
                : new TranslatableComponent("brute_force_rendering_culling.enable").append(" ").append(new TranslatableComponent("brute_force_rendering_culling.culling"))));
